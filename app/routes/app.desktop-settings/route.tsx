...
export default function Index() {
  ...
  // const generateProduct = () => submit({data: formData.location}, { replace: true, method: "POST" });
  const currentSetting = { ...settings, desktop: formData }
  return (
    <Page>
      <ui-title-bar title="Desktop Settings">
        <button variant="primary" onClick={() => console.log(toPMSettings(currentSetting), 'aaaa')}>
          Save
        </button>
      </ui-title-bar>
